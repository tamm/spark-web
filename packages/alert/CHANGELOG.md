...
- [#198](https://github.com/brighte-labs/spark-web/pull/198)
  ...
  Thanks [@lukebennett88](https://github.com/lukebennett88)! - Fix type for
  Alert's icon prop
...
- [#180](https://github.com/brighte-labs/spark-web/pull/180)
  ...
  Thanks [@lukebennett88](https://github.com/lukebennett88)! - If either
  `onClose` or `closeLabel` are provided, the other is also required
